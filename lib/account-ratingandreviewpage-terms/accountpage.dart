...
class BabysitterAccountPage extends StatelessWidget {
  const BabysitterAccountPage({super.key});
        ...
        child: Column(
          children: [
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              const EditBabysitterProfilePage(),
                        ),
                      );
                    },
            ...
            Row(
              children: [
                const SizedBox(width: 16),
                const Icon(Icons.male, color: AppColors.lightCoffeeBrown),
                const SizedBox(width: 8),
                const Text(
                  "Male",
                  style: TextStyle(fontSize: 14, color: AppColors.grayColor),
            ...
            const Padding(
              ...
              child: Text(
                "Hi, I'm Adrian! I've been caring for babies for over 5 years and have plenty of work experience with little ones. Since I work from home, I'm available throughout the day, making it easy for me to support your family's needs. If you have any questions, feel free to reach out!",
